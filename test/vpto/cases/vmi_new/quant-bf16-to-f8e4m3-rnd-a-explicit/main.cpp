...
void LaunchVmi_quant_bf16_to_f8e4m3_rnd_a_explicit_kernel(uint16_t *src, uint8_t *dst,
                                               void *stream);
...
int main() {
  ...
  LaunchVmi_quant_bf16_to_f8e4m3_rnd_a_explicit_kernel(srcDevice, dstDevice, stream);
