...
# Golden reference for Phase 1 path bf16 -> f8E4M3FN with explicit
# rounding = "A" (round away-from-zero).  Values are exact in both bf16 and
# f8E4M3FN so the output byte is independent of the rounding mode; the test
# thus validates attribute propagation (rnd="A" reaches vpto vcvt) rather
# than rounding behaviour.
#
# f8E4M3FN byte encoding:
#   0.0   -> 0x00
#   +1.0  -> 0x38
#   -1.0  -> 0xB8
#   +0.5  -> 0x30
